...
class Level1(tools._State):
    ...
    def setup_bricks(self):
        ...
        brick3  = bricks.Brick(944,  279)
        brick4  = bricks.Brick(987,  279)
        brick5  = bricks.Brick(1030,  279)
        brick6  = bricks.Brick(1073,  279)
        brick7  = bricks.Brick(1116,  279)
        brick8  = bricks.Brick(1159,  279)
        brick9  = bricks.Brick(1202,  279)
        brick10  = bricks.Brick(1030, 365)
        brick11  = bricks.Brick(3299, 365)
        brick12  = bricks.Brick(3385, 365)
        brick13  = bricks.Brick(3428, 365)
        brick14  = bricks.Brick(3471, 365)
        brick15  = bricks.Brick(3514, 365)
        brick16  = bricks.Brick(3557, 365)
        brick17  = bricks.Brick(3600, 365)
        brick18  = bricks.Brick(3643, 365)
        brick19  = bricks.Brick(3686, 365)
        brick20  = bricks.Brick(3729, 365)
        brick21  = bricks.Brick(3772, 365)
        brick22  = bricks.Brick(3815, 365)
        brick23  = bricks.Brick(3430, 193)
        brick24  = bricks.Brick(3473, 193)
        brick25  = bricks.Brick(3516, 193)
        brick26  = bricks.Brick(3559, 193)
        brick27 = bricks.Brick(3602, 193)
        brick28 = bricks.Brick(3645, 193)
        brick29 = bricks.Brick(3688, 193)
        brick30 = bricks.Brick(3731, 193)
        brick31 = bricks.Brick(3901, 193)
        brick32 = bricks.Brick(3944, 193)
        brick33 = bricks.Brick(3987, 193)
        brick33 = bricks.Brick(4030, 365, c.SIXCOINS, self.coin_group)
        brick34 = bricks.Brick(4287, 365)
        brick35 = bricks.Brick(4330, 365, c.STAR, self.powerup_group)
        brick36 = bricks.Brick(5058, 365)
        brick37 = bricks.Brick(5187, 193)
        brick38 = bricks.Brick(5230, 193)
        brick39 = bricks.Brick(5273, 193)
        brick40 = bricks.Brick(5488, 193)
        brick41 = bricks.Brick(5574, 193)
        brick42 = bricks.Brick(5617, 193)
        brick43 = bricks.Brick(5531, 365)
        brick44 = bricks.Brick(5574, 365)
        brick45 = bricks.Brick(7202, 365)
        brick46 = bricks.Brick(7245, 365)
        brick47 = bricks.Brick(7331, 365)
